...
if __name__ == "__main__":
    ...
    param_list = []
    for (new_object, tot_ep_exploration), (same_position, obstacle), (learning_rate, batch_size, n_epochs, ent_coef, gamma), max_steps, timesteps, seed in param_combinations:
